...
ChatLogic::ChatLogic()
{
    ...
    // Removing allocation in the constructor,Since it is now a smart pointer
...
ChatLogic::~ChatLogic()
{
    ...
    ////
    //Task 3 : Exclusive Ownership 2
    // Similarla Remove Deallocation in the constructor,Since it is now a smart pointer
